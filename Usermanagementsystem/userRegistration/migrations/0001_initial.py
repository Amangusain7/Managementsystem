# Generated by Django 3.1.6 on 2021-02-27 07:11

from django.db import migrations, models
import userRegistration.manager
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_image', models.ImageField(blank=True, null=True, upload_to='', verbose_name='profile picture')),
                ('role', models.CharField(choices=[('admin', 'admin'), ('user', 'user'), ('manager', 'manager')], default=None, max_length=50, null=True)),
            ...
            managers=[
                ('objects', userRegistration.manager.UserManager()),
            ],
        ),
    ]
